...
param CFG_ELEMENTS[] =
{
    ...
    */
    {"CountryRegion", "CountryRegion", NULL, hooker,  "1"},
    {"CountryRegionABand", "CountryRegionABand", NULL, hooker, "7"},
    {"CountryCode", "CountryCode", NULL, hooker, NULL},
    ...
    {"WirelessMode", "WirelessMode", NULL, hooker,  "9"},
    {"TxRate", "TxRate", NULL, hooker, "0"},
    {"Channel", "Channel", NULL, hooker,  "0"},
    {"BasicRate", "BasicRate", NULL, hooker, "15"},
    {"BeaconPeriod", "BeaconPeriod", NULL, hooker,  "100"},
    {"DtimPeriod", "DtimPeriod", NULL, hooker,  "1"},
    {"TxPower", "TxPower", NULL, hooker,  "100"},
    {"DisableOLBC", "DisableOLBC", NULL, hooker, "0"},
    {"BGProtection", "BGProtection", NULL, hooker,  "0"},
    {"TxAntenna", "TxAntenna", NULL, hooker, NULL},
    {"RxAntenna", "RxAntenna", NULL, hooker, NULL},
    {"TxPreamble", "TxPreamble", NULL, hooker,  "0"},
    {"RTSThreshold", "RTSThreshold", NULL, hooker,  "2347"},
    {"FragThreshold", "FragThreshold", NULL, hooker,  "2346"},
    {"TxBurst", "TxBurst", NULL, hooker,  "1"},
    {"PktAggregate", "PktAggregate", NULL, hooker,  "0"},
    {"TurboRate", "TurboRate", NULL, hooker, "0"},
    {"WmmCapable", "WmmCapable", NULL, hooker, "1"},
    {"APSDCapable", "APSDCapable", NULL, hooker, "1"},
    {"DLSCapable", "DLSCapable", NULL, hooker, "0"},
    ...
    {"NoForwarding", "NoForwarding", NULL, hooker, "0"},
    {"NoForwardingBTNBSSID", NULL, NULL, NULL, "0"},
    {"HideSSID", "HideSSID", NULL, hooker,  "0"},
    {"StationKeepAlive", NULL, NULL, NULL, "0"},
    {"ShortSlot", "ShortSlot", NULL, hooker,  "1"},
    {"AutoChannelSelect", "AutoChannelSelect", NULL, hooker, "2"},
    ...
    {"RekeyInterval", "RekeyInterval", NULL, hooker, "0"},
    ...
    {"WdsEnable", "WdsEnable", NULL, hooker, "0"},
    {"WdsEncrypType", "WdsEncrypType", NULL, hooker, "NONE"},
    ...
    {"RADIUS_Server", "RADIUS_Server", NULL, hooker, NULL},
    {"RADIUS_Port", "RADIUS_Port", NULL, hooker, NULL},
    {"RADIUS_Key1", "RADIUS_Key1", NULL, hooker, NULL},
    {"RADIUS_Key2", "RADIUS_Key2", NULL, hooker, NULL},
    {"RADIUS_Key3", "RADIUS_Key3", NULL, hooker, NULL},
    ...
    {"HT_BW", "HT_BW", NULL, hooker,  "0"},
    {"VHT_BW", "VHT_BW", NULL, hooker,  "0"},
    {"VHT_Sec80_Channel", "VHT_Sec80_Channel", NULL, hooker, NULL},
    {"VHT_SGI", "VHT_SGI", NULL, hooker,  "1"},
    {"VHT_STBC", "VHT_STBC", NULL, hooker, "0"},
    {"VHT_BW_SIGNAL", "VHT_BW_SIGNAL", NULL, hooker,  "0"},
    {"VHT_DisallowNonVHT", "VHT_DisallowNonVHT", NULL, hooker, NULL},
    ...
    {"AutoProvisionEn", "AutoProvisionEn", NULL, hooker, "0"},
    ...
    {"DfsLowerLimit", "DfsLowerLimit", NULL, hooker, "0"},
    {"DfsUpperLimit", "DfsUpperLimit", NULL, hooker, "0"},
    {"DfsOutdoor", "DfsOutdoor", NULL, hooker, "0"},
    ...
    {"LongPulseRadarTh", "LongPulseRadarTh", NULL, hooker, "0"},
    ...
    {"MeshAutoLink", "MeshAutoLink", NULL, hooker, "0"},
    {"MeshAuthMode", "MeshAuthMode", NULL, hooker, NULL},
    {"MeshEncrypType", "MeshEncrypType", NULL, hooker, NULL},
    {"MeshDefaultkey", "MeshDefaultkey", NULL, hooker, "0"},
    {"MeshWEPKEY", "MeshWEPKEY", NULL, hooker, NULL},
    {"MeshWPAKEY", "MeshWPAKEY", NULL, hooker, NULL},
    {"MeshId", "MeshId", NULL, hooker, NULL},
    {"HSCounter", "HSCounter", NULL, hooker, "0"},
    {"HT_BADecline", "HT_BADecline", NULL, hooker, "0"},
    ...
    {"HT_DisallowTKIP", "HT_DisallowTKIP", NULL, hooker, "0"},
    {"HT_BSSCoexistence", "HT_BSSCoexistence", NULL, hooker, "0"},
    {"WscConfMode", "WscConfMode", NULL, hooker, "0"},
    {"WscConfStatus", "WscConfStatus", NULL, hooker, "2"},
    {"WCNTest", "WCNTest", NULL, hooker, "0"},
    {"WdsPhyMode", "WdsPhyMode", NULL, hooker, NULL},
    {"RADIUS_Acct_Server", "RADIUS_Acct_Server", NULL, hooker, NULL},
    {"RADIUS_Acct_Port", "RADIUS_Acct_Port", NULL, hooker, "1813"},
    {"RADIUS_Acct_Key", "RADIUS_Acct_Key", NULL, hooker, NULL},
    {"Ethifname", "Ethifname", NULL, hooker, NULL},
    {"session_timeout_interval", "session_timeout_interval", NULL, hooker, "0"},
    {"idle_timeout_interval", "idle_timeout_interval", NULL, hooker, "0"},
    ...
    {"EfuseBufferMode", "EfuseBufferMode", NULL, hooker, "0"},
    {"E2pAccessMode", "E2pAccessMode", NULL, hooker, "1"},
    {"RadioOn", "RadioOn", NULL, hooker, "1"},
    {"BW_Enable", "BW_Enable", NULL, hooker, "0"},
    {"BW_Root", "BW_Root", NULL, hooker, "0"},
    {"BW_Priority", "BW_Priority", NULL, hooker, NULL},
    {"BW_Guarantee_Rate", "BW_Guarantee_Rate", NULL, hooker, NULL},
    {"BW_Maximum_Rate", "BW_Maximum_Rate", NULL, hooker, NULL},

    /* add more configurations */
    {"AutoChannelSkipList", "AutoChannelSkipList", NULL, hooker, NULL},
    {"WscConfMethod", "WscConfMethod", NULL, hooker, NULL},
    {"WscKeyASCII", "WscKeyASCII", NULL, hooker, NULL},
    {"WscSecurityMode", "WscSecurityMode", NULL, hooker, NULL},
    {"Wsc4digitPinCode", "Wsc4digitPinCode", NULL, hooker, NULL},
    {"WscVendorPinCode", "WscVendorPinCode", NULL, hooker, NULL},
    {"WscV2Support", "WscV2Support", NULL, hooker, NULL},
    {"HT_MIMOPS", "HT_MIMOPS", NULL, hooker, "3"},
    {"G_BAND_256QAM", "G_BAND_256QAM", NULL, hooker, "1"},
    {"DBDC_MODE", "DBDC_MODE", NULL, hooker, "0"},
    {"IgmpSnEnable", "IgmpSnEnable", NULL, hooker, "1"},
