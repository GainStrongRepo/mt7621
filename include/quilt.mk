...
define Quilt/Refresh/Kernel
	...
	# Hua Shao: hacked to integrate mtk wifi drivers into kernel.
	wifidevs="$(shell cat $(1)/patches/series | grep -v generic | grep -v platform | awk '{split($$$$0,a,"/") ; print a[1]}' | awk '!a[$$$$0]++')";\
	for wifidev in $$$${wifidevs}; do\
		$(call Quilt/RefreshDir,$(PKG_BUILD_DIR),$(TOPDIR)/package/mtk/drivers/$$$${wifidev}/patches,$$$${wifidev}/);\
	done
endef
